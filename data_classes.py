...
# Desc: This module contains the Person and Employee data classes with validation
...
class Employee(Person):
    ...
    Properties:
        first_name (str): Inherited from Person. Defaults to empty string.
        last_name (str): Inherited from Person. Defaults to empty string.
        review_date (str): The date of the employee review in YYYY-MM-DD format. Defaults to "1900-01-01".
        review_rating (int): The review rating of the employee's performance (1-5). Defaults to 3.
